    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="nuevoPrestamo" action="<?php echo base_url() ?>index.php/Prestamos_maestro/nuevoPrestamo" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <!-- <div class="col-sm-9"> -->
                                ...
                                <option data-material="N/A" value="">Selecciona una categoria</option>
                    ...
                    <div class="form-group">
                        ...
                        <!-- <div class="col-sm-9"> -->
                                ...
                                <option data-material="N/A" value="" disabled selected>Selecciona un material</option>
...
<div class="modal" id="modal-detalles" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="detallesPrestamo" action="<?php echo base_url() ?>index.php/Prestamo_maestro/detallesPrestamo" method="POST">
                    <div class="form-group">
                        <label>Fecha de prestamo</label>
...
<script>
    ...
    $('#nuevoPrestamo').submit(function() {
        ...
        && $('input[name="Material"]').val() !== "" && $('input[name="Cantidad"]').val() !== "") {
            $.ajax({
                url: 'Prestamos_maestro/nuevoPrestamo', 
                type: "post",
    ...
    $(document).ready(function(){
        $("#Categoria").change(function(){
                ...
                $.get('<?php echo base_url('index.php/Prestamos_maestros/getEquipoId/')?>' + $('#Categoria').val(), function(datos, status){
