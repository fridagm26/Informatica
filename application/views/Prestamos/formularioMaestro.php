	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="form-group col-md-12">
				...
				<input name="txtubicacion" data-info="<?php echo(isset($laboratorios[0]->ubicacion)) ? $laboratorios[0]->ubicacion : '' ?>" value="<?php echo(isset($laboratorios[0]->ubicacion)) ? $laboratorios[0]->ubicacion : '' ?>" class="form-control LetrasNumeros" id="txtubicacion" placeholder="Ingrese ubicacion">
			</div>
		</div>
        <div class="row">
			<div class="form-group col-md-12">
